...
* Unit 15 does not have a required homework in order to allow more time for the machine learning project, however there are two optional homework activities available for students that want an extra challenge:

  * [Algorithmic Trading Optional Homework Files](../../../02-Homework/15-Algorithmic-Trading/README.md)
