...
* Remind students to check out the [Student Guide](../Supplemental/StudentGuide.md), which contains helpful information and frequently asked questions about this unit.
...
The slides for this lesson can be viewed on Google Drive here: [Lesson Slides](https://docs.google.com/presentation/d/1z-Oo_JdVhnsxuTbMt-JHEUR2yLE2EMYXR_e1bJcS6OA/edit?usp=sharing).
